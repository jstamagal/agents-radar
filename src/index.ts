...
import { saveWebReport, saveTrendingReport, saveHnReport, saveWideViewReport } from "./report-savers.ts";
...
async function main(): Promise<void> {
  ...
  await Promise.all([
    ...
    saveWideViewReport(trendingData, utcStr, dateStr, digestRepo, autoGenFooter("zh"), "zh"),
    saveWideViewReport(trendingData, utcStr, dateStr, digestRepo, autoGenFooter("en"), "en"),
  ]);
  ...
  for (const [id, zhFile, enFile] of [
    ...
    ["ai-wide-view", "ai-wide-view.md", "ai-wide-view-en.md"],
  ] as const) {
