...
async function main(): Promise<void> {
  ...
  // 5a. Generate panorama report (wide view across all daily signals)
  await Promise.all([
    savePanoramaReport(zhReports, utcStr, dateStr, digestRepo, autoGenFooter("zh"), "zh"),
    savePanoramaReport(enReports, utcStr, dateStr, digestRepo, autoGenFooter("en"), "en"),
  ]);
