...
async function main(): Promise<void> {
  ...
  await Promise.all([
    ...
    saveSignalsReport(trendingData, hnData, webResults, utcStr, dateStr, digestRepo, autoGenFooter("zh"), "zh"),
    saveSignalsReport(trendingData, hnData, webResults, utcStr, dateStr, digestRepo, autoGenFooter("en"), "en"),
  ]);
