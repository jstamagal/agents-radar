...
export const SIGNALS_REPORT = {
  title: t("AI 生态信号全景图", "AI Ecosystem Signals: Wide View"),
  sources: t(
  ...
  issueTitle: (dateStr: string, lang: Lang) =>
    lang === "en"
      ? `🗺️ AI Ecosystem Signals: Wide View ${dateStr}`
      : `🗺️ AI 生态信号全景图 ${dateStr}`,
} as const;
...
export const REPORT_LABELS: Record<string, string> = {
  ...
  "ai-signals": "AI 生态信号全景图",
  "ai-signals-en": "AI Ecosystem Signals: Wide View",
  "ai-weekly": "AI 工具生态周报",
...
export const NOTIFY_LABELS: Record<string, Record<Lang, string>> = {
  ...
  "ai-signals": t("AI 生态全景", "AI Ecosystem Signals"),
