...
export const SYNTHESIS_REPORT = {
  title: t("AI 生态全景日报", "AI Ecosystem Panorama"),
  sources: t(
    "数据来源: GitHub Trending + Hacker News + 官方内容",
    "Sources: GitHub Trending + Hacker News + Official Content",
  ),
  issueTitle: (dateStr: string, lang: Lang) =>
...
export const ISSUE_LABELS = {
  ...
  hn: t("hn", "hn-en"),
  synthesis: t("synthesis", "synthesis-en"),
} as const;
...
export const REPORT_LABELS: Record<string, string> = {
  ...
  "ai-synthesis": "AI 生态全景日报",
  "ai-synthesis-en": "AI Ecosystem Panorama",
  "ai-weekly": "AI 工具生态周报",
...
export const NOTIFY_LABELS: Record<string, Record<Lang, string>> = {
  ...
  "ai-synthesis": t("AI 生态全景", "AI Ecosystem Panorama"),
