...
export const SIGNALS_REPORT = {
  title: t("AI 开源信号全景", "AI Open Source Signals — Wide View"),
  sources: t(
    "数据来源: GitHub Trending + GitHub Search API + Hacker News",
    "Sources: GitHub Trending + GitHub Search API + Hacker News",
  ),
  issueTitle: (dateStr: string, lang: Lang) =>
    lang === "en" ? `🔭 AI Open Source Signals ${dateStr}` : `🔭 AI 开源信号全景 ${dateStr}`,
} as const;
...
export const REPORT_LABELS: Record<string, string> = {
  ...
  "ai-signals": "AI 开源信号全景",
  "ai-signals-en": "AI Open Source Signals",
  "ai-weekly": "AI 工具生态周报",
...
export const NOTIFY_LABELS: Record<string, Record<Lang, string>> = {
  ...
  "ai-signals": t("AI 信号全景", "AI Signals"),
