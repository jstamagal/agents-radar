...
export const WIDE_VIEW_REPORT = {
  title: t("AI 开源信号全景视图", "AI Open Source Signal Wide View"),
  sources: t("数据来源: GitHub Trending + GitHub Search API", "Sources: GitHub Trending + GitHub Search API"),
  issueTitle: (dateStr: string, lang: Lang) =>
    lang === "en" ? `🌐 AI Open Source Signal Wide View ${dateStr}` : `🌐 AI 开源信号全景视图 ${dateStr}`,
} as const;
...
export const ISSUE_LABELS = {
  ...
  hn: t("hn", "hn-en"),
  wideView: t("wide-view", "wide-view-en"),
} as const;
...
export const REPORT_LABELS: Record<string, string> = {
  ...
  "ai-wide-view": "AI 开源信号全景视图",
  "ai-wide-view-en": "AI Open Source Signal Wide View",
  "ai-weekly": "AI 工具生态周报",
