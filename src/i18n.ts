...
export const SIGNALS_REPORT = {
  title: t("AI 信号全景日报", "AI Signals Panorama"),
  sources: t(
    "数据来源: GitHub Trending + Hacker News + 官方网站",
    "Sources: GitHub Trending + Hacker News + Official Sites",
  ),
  issueTitle: (dateStr: string, lang: Lang) =>
    lang === "en" ? `🔭 AI Signals Panorama ${dateStr}` : `🔭 AI 信号全景日报 ${dateStr}`,
} as const;
...
export const REPORT_LABELS: Record<string, string> = {
  ...
  "ai-signals": "AI 信号全景日报",
  "ai-signals-en": "AI Signals Panorama",
  "ai-weekly": "AI 工具生态周报",
...
export const NOTIFY_LABELS: Record<string, Record<Lang, string>> = {
  ...
  "ai-signals": t("AI 信号全景", "AI Signals Panorama"),
