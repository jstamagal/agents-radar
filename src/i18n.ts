...
export const LANDSCAPE_REPORT = {
  title: t("AI 开源生态全景报告", "AI Open Source Landscape"),
  sources: t(
    "数据来源: GitHub Trending + GitHub Search API",
    "Sources: GitHub Trending + GitHub Search API",
  ),
  issueTitle: (dateStr: string, lang: Lang) =>
    lang === "en" ? `🗺️ AI Open Source Landscape ${dateStr}` : `🗺️ AI 开源生态全景报告 ${dateStr}`,
} as const;
...
export const REPORT_LABELS: Record<string, string> = {
  ...
  "ai-landscape-en": "AI Open Source Landscape",
  "ai-weekly": "AI 工具生态周报",
...
export const NOTIFY_LABELS: Record<string, Record<Lang, string>> = {
  ...
  "ai-landscape": t("AI 生态全景", "AI Landscape"),
