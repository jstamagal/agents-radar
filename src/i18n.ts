...
export const SIGNALS_REPORT = {
  title: t("AI 开源信号全景", "AI Open Source Signal Snapshot"),
  sources: t(
  ...
  issueTitle: (dateStr: string, lang: Lang) =>
    lang === "en"
      ? `🔭 AI Open Source Signal Snapshot ${dateStr}`
      : `🔭 AI 开源信号全景 ${dateStr}`,
} as const;
...
export const REPORT_LABELS: Record<string, string> = {
  ...
  "ai-signals-en": "AI Open Source Signal Snapshot",
  "ai-weekly": "AI 工具生态周报",
...
export const NOTIFY_LABELS: Record<string, Record<Lang, string>> = {
  ...
  "ai-signals": t("AI 开源信号全景", "AI Signal Snapshot"),
