...
describe("issue title functions", () => {
  ...
  it("SIGNALS_REPORT.issueTitle produces zh and en", () => {
    expect(SIGNALS_REPORT.issueTitle("2026-03-20", "zh")).toContain("信号全景");
    expect(SIGNALS_REPORT.issueTitle("2026-03-20", "zh")).toContain("2026-03-20");
    expect(SIGNALS_REPORT.issueTitle("2026-03-20", "en")).toContain("AI Open Source Signals");
  });
