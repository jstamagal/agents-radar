...
describe("issue title functions", () => {
  ...
  it("SIGNALS_REPORT.issueTitle produces zh and en", () => {
    expect(SIGNALS_REPORT.issueTitle("2026-03-12", "zh")).toContain("信号全景");
    expect(SIGNALS_REPORT.issueTitle("2026-03-12", "en")).toContain("Signals Panorama");
    expect(SIGNALS_REPORT.issueTitle("2026-03-12", "zh")).toContain("2026-03-12");
    expect(SIGNALS_REPORT.issueTitle("2026-03-12", "en")).toContain("2026-03-12");
  });
