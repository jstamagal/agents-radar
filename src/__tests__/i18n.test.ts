...
describe("issue title functions", () => {
  ...
  it("SIGNALS_REPORT.issueTitle produces zh and en", () => {
    expect(SIGNALS_REPORT.issueTitle("2026-03-14", "zh")).toContain("全景");
    expect(SIGNALS_REPORT.issueTitle("2026-03-14", "zh")).toContain("2026-03-14");
    expect(SIGNALS_REPORT.issueTitle("2026-03-14", "en")).toContain("Wide-View");
    expect(SIGNALS_REPORT.issueTitle("2026-03-14", "en")).toContain("2026-03-14");
  });
