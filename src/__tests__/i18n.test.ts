...
describe("issue title functions", () => {
  ...
  it("SIGNALS_REPORT.issueTitle produces zh and en", () => {
    expect(SIGNALS_REPORT.issueTitle("2026-04-04", "zh")).toContain("信号全景");
    expect(SIGNALS_REPORT.issueTitle("2026-04-04", "zh")).toContain("2026-04-04");
    expect(SIGNALS_REPORT.issueTitle("2026-04-04", "en")).toContain("Signal Snapshot");
  });
